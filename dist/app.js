(function () {
	...
	*/
	...
	var react_development = createCommonjsModule(function (module) {

	  {
	    (function () {
	       ...
	       * @return {string}
	       */
	      function getComponentKey(component, index$$1) {
	...
	var index_1 = index$1.Component;
	var index_2 = index$1.Fragment;
	var index_3 = index$1.Children;
	var index_4 = index$1.createElement;
	...
	*/
	...
	function camelizeStyleName(string) {
	  return camelize$1(string.replace(msPattern$1, 'ms-'));
	}

	var camelizeStyleName_1 = camelizeStyleName;

	var reactDom_development=createCommonjsModule(function(module){{(function(){var React=index$1;var invariant=invariant_1;var warning=warning_1;var ExecutionEnvironment=ExecutionEnvironment_1;var _assign=index;var emptyFunction=emptyFunction_1;var checkPropTypes=checkPropTypes_1;var getActiveElement=getActiveElement_1;var shallowEqual=shallowEqual_1;var containsNode=containsNode_1;var emptyObject=emptyObject_1;var hyphenateStyleName=hyphenateStyleName_1;var camelizeStyleName=camelizeStyleName_1;/**
	 * WARNING: DO NOT manually require this module.
	 * This is a replacement for `invariant(...)` used by the error code system
	 * and will _only_ be required by the corresponding babel pass.
	 * It always throws.
	...
	if(node.hasOwnProperty(valueField)||typeof descriptor.get!=='function'||typeof descriptor.set!=='function'){return;}Object.defineProperty(node,valueField,{configurable:true,get:function get$$1(){return descriptor.get.call(this);},set:function set$$1(value){currentValue=''+value;descriptor.set.call(this,value);}});// We could've passed this the first time
	      ...
	      if (secret !== ReactPropTypesSecret$2) {
	        if (throwOnDirectAccess) {
	          ...
	          manualPropTypeWarningCount < 3) {
	            warning$3(false, 'You are manually calling a React.PropTypes validation ' + 'function for the `%s` prop on `%s`. This is deprecated ' + 'and will throw in the standalone `prop-types` package. ' + 'You may be seeing this warning due to a third-party PropTypes ' + 'library. See https://fb.me/react-warning-dont-call-proptypes ' + 'for details.', propFullName, componentName);
	  ...
	  function createUnionTypeChecker(arrayOfTypeCheckers) {
	    ...
	    for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
	      ...
	      if (typeof checker !== 'function') {
	        warning$3(false, 'Invalid argument supplied to oneOfType. Expected an array of check functions, but ' + 'received %s at index %s.', getPostfixForTypeWarning(checker), i);
	        return emptyFunction$2.thatReturnsNull;
	      }
	    }
	...
	function createProvider() {
	  ...
	  var Provider = function (_Component) {
	    ...
	    Provider.prototype.render = function render() {
	      return index_3.only(this.props.children);
	    };
	...
	*/
	    ...
	    var Connect = function (_Component) {
	      ...
	      Connect.prototype.render = function render() {
	        ...
	        if (selector.error) {
	          ...
	          return index_4(WrappedComponent, this.addExtraProps(selector.props));
	        }
	      };
	...
	var AddTodo = function (_Component) {
	  inherits(AddTodo, _Component);

	  function AddTodo(props) {
	    classCallCheck(this, AddTodo);

	    var _this = possibleConstructorReturn(this, (AddTodo.__proto__ || Object.getPrototypeOf(AddTodo)).call(this, props));
	  ...
	  createClass(AddTodo, [{
	    ...
	    value: function render() {
	      ...
	      return index$1.createElement(
	        index_2,
	        null,
	        index$1.createElement('input', { type: 'text', ref: function ref(node) {
	            return _this2.input = node;
	          } }),
	        index$1.createElement(
	          'button',
	...
	AddTodo.propTypes = {
	  onAddClick: index$3.func.isRequired
	};

	var Todo = function (_Component) {
	  inherits(Todo, _Component);

	  function Todo() {
	    classCallCheck(this, Todo);
	    return possibleConstructorReturn(this, (Todo.__proto__ || Object.getPrototypeOf(Todo)).apply(this, arguments));
	  }
	...
	Todo.propTypes = {
	  onClick: index$3.func.isRequired,
	  text: index$3.string.isRequired,
	  completed: index$3.bool.isRequired
	};
	...
	var TodoList = function (_Component) {
	  ...
	  function TodoList() {
	    ...
	    return possibleConstructorReturn(this, (TodoList.__proto__ || Object.getPrototypeOf(TodoList)).apply(this, arguments));
	  }
	  ...
	  createClass(TodoList, [{
	    ...
	    value: function render() {
	      ...
	      return index$1.createElement(
	        'ul',
	        null,
	        this.filterTodos().map(function (todo, index) {
	          return index$1.createElement(Todo, _extends({}, todo, {
	            key: index,
	...
	TodoList.propTypes = {
	  onTodoClick: index$3.func.isRequired,
	  todos: index$3.arrayOf(index$3.shape({
	    text: index$3.string.isRequired,
	    completed: index$3.bool.isRequired
	  }).isRequired).isRequired,
	  filter: index$3.string.isRequired
	};
	...
	Footer.propTypes = {
	  onFilterChange: index$3.func.isRequired,
	  filter: index$3.oneOf(['SHOW_ALL', 'SHOW_COMPLETED', 'SHOW_ACTIVE']).isRequired
	};
	  ...
	  createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return index$1.createElement(
	        index_2,
	        null,
	        index$1.createElement(AddTodo, {
	          onAddClick: function onAddClick(text) {
	            return _this2.props.onAddClick(text);
	          }
	        }),
	        index$1.createElement(TodoList, {
	...
	var App$1 = connect(maps.stateToProps, maps.dispatchToProps)(App);
	...
	var todos = function todos() {
	  ...
	  switch (action.type) {
	    ...
	    case Types.COMPLETE_TODO:
	      return todos.reduce(function (prev, next, index) {
	...
	var root$2 = document.getElementById('root');

	index_1$1(index$1.createElement(
	  Provider,
	  { store: store },
	  index$1.createElement(App$1, null)
	), root$2);
